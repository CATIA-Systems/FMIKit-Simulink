...
fmi3Status fmi3GetFMUstate(fmi3Component c, fmi3FMUstate* FMUstate) { NOT_IMPLEMENTED }
fmi3Status fmi3SetFMUstate(fmi3Component c, fmi3FMUstate  FMUstate) { NOT_IMPLEMENTED }
fmi3Status fmi3FreeFMUstate(fmi3Component c, fmi3FMUstate* FMUstate) { NOT_IMPLEMENTED }
fmi3Status fmi3SerializedFMUstateSize(fmi3Component c, fmi3FMUstate  FMUstate, size_t* size) { NOT_IMPLEMENTED }
fmi3Status fmi3SerializeFMUstate(fmi3Component c, fmi3FMUstate  FMUstate, fmi3Byte serializedState[], size_t size) { NOT_IMPLEMENTED }
fmi3Status fmi3DeSerializeFMUstate(fmi3Component c, const fmi3Byte serializedState[], size_t size, fmi3FMUstate* FMUstate) { NOT_IMPLEMENTED }
...
fmi3Status fmi3EnterEventMode(fmi3Component c) { NOT_IMPLEMENTED }
fmi3Status fmi3NewDiscreteStates(fmi3Component c, fmi3EventInfo* fmi3eventInfo) { NOT_IMPLEMENTED }
fmi3Status fmi3EnterContinuousTimeMode(fmi3Component c) { NOT_IMPLEMENTED }
...
fmi3Status fmi3SetTime(fmi3Component c, fmi3Float64 time) { NOT_IMPLEMENTED }
fmi3Status fmi3SetContinuousStates(fmi3Component c, const fmi3Float64 x[], size_t nx) { NOT_IMPLEMENTED }

/* Evaluation of the model equations */
fmi3Status fmi3GetDerivatives(fmi3Component c, fmi3Float64 derivatives[], size_t nx) { NOT_IMPLEMENTED }
fmi3Status fmi3GetEventIndicators(fmi3Component c, fmi3Float64 eventIndicators[], size_t ni) { NOT_IMPLEMENTED }
fmi3Status fmi3GetContinuousStates(fmi3Component c, fmi3Float64 x[], size_t nx) { NOT_IMPLEMENTED }
fmi3Status fmi3GetNominalsOfContinuousStates(fmi3Component c, fmi3Float64 x_nominal[], size_t nx) { NOT_IMPLEMENTED }
...
fmi3Status fmi3CancelStep(fmi3Component c) { NOT_IMPLEMENTED }
